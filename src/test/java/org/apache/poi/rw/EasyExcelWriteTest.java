...
//        // 写法1 JDK8+
//        // since: 3.0.0-beta1
//        String fileName = "E:\\self\\POI\\mee-excel\\src\\test\\java\\org\\apache\\poi\\rw\\write.xls";
...
//
//        // 写法2
//        fileName = "E:\\self\\POI\\mee-excel\\src\\test\\java\\org\\apache\\poi\\rw\\write2.xls";
//        // 这里 需要指定写用哪个class去写，然后写到第一个sheet，名字为模板 然后文件流会自动关闭
//        // 如果这里想使用03 则 传入excelType参数即可
//        EasyExcel.write(fileName, TestEntity.class)
...
//
//        // 写法3
//        fileName = "E:\\self\\POI\\mee-excel\\src\\test\\java\\org\\apache\\poi\\rw\\write3.xls";
//        // 这里 需要指定写用哪个class去写
...
//        String fileName = "E:\\self\\POI\\mee-excel\\src\\test\\java\\org\\apache\\poi\\rw\\write4.xlsx";
//
...
//        String fileName = "E:\\self\\POI\\mee-excel\\src\\test\\java\\org\\apache\\poi\\rw\\write5.xlsx";
//
//        // 这里注意下 所有的图片都会放到内存 暂时没有很好的解法，大量图片的情况下建议 2选1:
//        // 1. 将图片上传到oss 或者其他存储网站: https://www.aliyun.com/product/oss ，然后直接放链接
//        // 2. 使用: https://github.com/coobird/thumbnailator 或者其他工具压缩图片
