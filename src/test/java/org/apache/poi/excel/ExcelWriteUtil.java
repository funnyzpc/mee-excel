...
public class ExcelWriteUtil {
    ...
    public static <T extends Object> File toXlsxByObj(
        ...
        if(null != cellFmts && cellFmts.length != cellNames.length){
            System.out.println(CELL_LENGTH_ERROR_MSG);
            return null;
        }
        /**
         * 构造文件夹
        ...
        try(SXSSFWorkbook workbook = new SXSSFWorkbook(null,ROW_ACCESS_WINDOW_SIZE,true,true);  FileOutputStream outputStream = new FileOutputStream(fileObject);){
            ...
            System.out.println("导出文件异常了 fileObject:"+fileObject+ioe);
        }
        System.out.println("===>已生成导出文件："+fileObject.getPath());
        return fileObject;
    }
...
//            workbook.dispose();
            ...
            System.out.println("导出文件异常了 fileObject:"+headerNames+ioe);
        }
    }
...
//            workbook.dispose();
            ...
            System.out.println("导出文件异常 fileObject:"+headerNames+ioe);
        }
    }
