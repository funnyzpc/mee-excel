        ...
        try(FileInputStream fi = new FileInputStream(file);
            ...
            for (int i = startRow; i < rowNum; i++) {
                ...
                for (int j = 0; j < colCount; j++) {
                    ...
                    if(startRow==i) {
                        // header row
                        if (null != cell && !"".equals(cell.getCellType().name())) {
...
//                }
            ...
            iOException.printStackTrace();
            System.out.println("错误 file:"+file+iOException);
    ...
    private static String readCellValue(XSSFCell cell){
        ...
        switch (cellType){
            ...
            case BLANK:
                return "";
            default:
                System.out.println("导入>未知数据类型! "+cellType);
                return null;
        }
    }
...
//        String cellType = cell.getCellTypeEnum().name();
        ...
        switch (cellTypeEnum){
            ...
            case BLANK:
                return "";
            default:
                System.out.println("导入>未知数据类型! "+cellTypeEnum);
                return null;
        }
    }
