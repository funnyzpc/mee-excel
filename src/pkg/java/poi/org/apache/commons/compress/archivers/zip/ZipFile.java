...
import poi.org.apache.commons.compress.archivers.EntryStreamOffsets;
...
import poi.org.apache.commons.compress.utils.BoundedArchiveInputStream;
import poi.org.apache.commons.compress.utils.BoundedSeekableByteChannelInputStream;
import poi.org.apache.commons.compress.utils.IOUtils;
import poi.org.apache.commons.compress.utils.InputStreamStatistics;
import poi.org.apache.commons.compress.utils.SeekableInMemoryByteChannel;
import poi.org.apache.commons.io.Charsets;
import poi.org.apache.commons.io.FilenameUtils;
import poi.org.apache.commons.io.build.AbstractOrigin.ByteArrayOrigin;
import poi.org.apache.commons.io.build.AbstractStreamBuilder;
import poi.org.apache.commons.io.input.CountingInputStream;
...
public class ZipFile implements Closeable {
    ...
    public static void closeQuietly(final ZipFile zipFile) {
        poi.org.apache.commons.io.IOUtils.closeQuietly(zipFile);
    }
    ...
    private static SeekableByteChannel openZipChannel(final Path path, final long maxNumberOfDisks, final OpenOption[] openOptions) throws IOException {
        ...
        try {
            ...
            poi.org.apache.commons.io.IOUtils.closeQuietly(channel);
            channels.forEach(poi.org.apache.commons.io.IOUtils::closeQuietly);
            throw ex;
        }
    }
    ...
    private ZipFile(final SeekableByteChannel channel, final String channelDescription, final Charset encoding, final boolean useUnicodeExtraFields,
        ...
        try {
            ...
            if (!success && closeOnError) {
                poi.org.apache.commons.io.IOUtils.closeQuietly(archive);
            }
        }
    }
