 ...
 */
package poi.org.apache.commons.compress.compressors.deflate64;

import poi.org.apache.commons.compress.utils.BitInputStream;
import poi.org.apache.commons.compress.utils.ByteUtils;
import poi.org.apache.commons.compress.utils.ExactMath;
import poi.org.apache.commons.lang3.ArrayFill;
        ...
        while (!finalBlock || state.hasData()) {
            if (state.state() == HuffmanState.INITIAL) {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    state = new HuffmanCodes(HuffmanState.FIXED_CODES, FIXED_LITERALS, FIXED_DISTANCE);
                    break;
                case 2:
                    final int[][] tables = readDynamicTables();
                    state = new HuffmanCodes(HuffmanState.DYNAMIC_CODES, tables[0], tables[1]);
                    break;
                default:
