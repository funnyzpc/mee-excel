...
public final class IOUtils {
     ...
     * @since 1.7
     * @deprecated Use {@link poi.org.apache.commons.io.IOUtils#closeQuietly(Closeable)}.
     */
    @Deprecated
    public static void closeQuietly(final Closeable c) {
        poi.org.apache.commons.io.IOUtils.closeQuietly(c);
    }
    ...
    public static int readFully(final InputStream input, final byte[] array, final int offset, final int length) throws IOException {
        ...
        return poi.org.apache.commons.io.IOUtils.read(input, array, offset, length);
    }
    ...
    public static void readFully(final ReadableByteChannel channel, final ByteBuffer byteBuffer) throws IOException {
        ...
        final int read = poi.org.apache.commons.io.IOUtils.read(channel, byteBuffer);
    ...
    public static byte[] readRange(final InputStream input, final int length) throws IOException {
        ...
        poi.org.apache.commons.io.IOUtils.copyLarge(input, output, 0, length);
    ...
    public static byte[] readRange(final ReadableByteChannel input, final int length) throws IOException {
        final ByteArrayOutputStream output = new ByteArrayOutputStream();
        final ByteBuffer b = ByteBuffer.allocate(Math.min(length, poi.org.apache.commons.io.IOUtils.DEFAULT_BUFFER_SIZE));
        int read = 0;
        while (read < length) {
    ...
    public static long skip(final InputStream input, final long toSkip) throws IOException {
        return poi.org.apache.commons.io.IOUtils.skip(input, toSkip, poi.org.apache.commons.io.IOUtils::byteArray);
    }
