...
public class X7875_NewUnix implements ZipExtraField, Cloneable, Serializable {
    ...
    public byte[] getLocalFileDataData() {
        ...
        int pos = 0;
        data[pos++] = ZipUtil.unsignedIntToSignedByte(version);
    ...
    public void parseFromLocalFileData(final byte[] data, int offset, final int length) throws ZipException {
        ...
        offset += uidSize;
        this.uid = new BigInteger(1, ZipUtil.reverse(uidBytes)); // sign-bit forced positive
        ...
        this.gid = new BigInteger(1, ZipUtil.reverse(gidBytes)); // sign-bit forced positive
    }
