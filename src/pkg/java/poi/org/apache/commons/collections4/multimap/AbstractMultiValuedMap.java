...
import poi.org.apache.commons.collections4.IteratorUtils;
import poi.org.apache.commons.collections4.MapIterator;
import poi.org.apache.commons.collections4.MultiSet;
import poi.org.apache.commons.collections4.MultiValuedMap;
import poi.org.apache.commons.collections4.Transformer;
import poi.org.apache.commons.collections4.iterators.AbstractIteratorDecorator;
import poi.org.apache.commons.collections4.iterators.EmptyMapIterator;
import poi.org.apache.commons.collections4.iterators.IteratorChain;
...
import poi.org.apache.commons.collections4.keyvalue.AbstractMapEntry;
import poi.org.apache.commons.collections4.keyvalue.UnmodifiableMapEntry;
import poi.org.apache.commons.collections4.multiset.AbstractMultiSet;
import poi.org.apache.commons.collections4.multiset.UnmodifiableMultiSet;
...
public abstract class AbstractMultiValuedMap<K, V> implements MultiValuedMap<K, V> {
    ...
    public Collection<V> remove(final Object key) {
        ...
        Collection<V> collection = getMap().remove(key);
    ...
    public boolean putAll(final K key, final Iterable<? extends V> values) {
        ...
        return it.hasNext() && addAll(get(key), it);
    }
    ...
    class WrappedCollection implements Collection<V> {
        ...
        public <T> T[] toArray(final T[] a) {
            final Collection<V> coll = getMapping();
            if (coll == null) {
                return (T[]) Collections.emptyList().toArray(a);
            }
