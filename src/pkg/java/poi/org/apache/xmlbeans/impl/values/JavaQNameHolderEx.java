...
import poi.org.apache.xmlbeans.impl.common.PrefixResolver;
...
public abstract class JavaQNameHolderEx extends JavaQNameHolder
{
    ...
    protected void set_text(String s)
    {
        ...
        if (_validateOnSet())
        {
            ...
            v = validateLexical(s, _voorVc, resolver);
    ...
    protected void set_xmlanysimple(XmlAnySimpleType value)
    {
        ...
        if (_validateOnSet())
        {
            ...
            v = validateLexical(value.getStringValue(), _voorVc, NamespaceContext.getCurrent());
    ...
    {
        QName name = validateLexical(v, context, resolver);
