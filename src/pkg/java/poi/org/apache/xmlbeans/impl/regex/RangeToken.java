...
package poi.org.apache.xmlbeans.impl.regex;
...
final class RangeToken extends Token implements java.io.Serializable {
    ...
    synchronized RangeToken getCaseInsensitiveToken() {
        ...
        RangeToken uppers = this.type == RANGE ? createRange() : createNRange();
        ...
        RangeToken lowers = this.type == RANGE ? createRange() : createNRange();
