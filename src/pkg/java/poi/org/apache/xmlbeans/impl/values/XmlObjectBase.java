...
import poi.org.apache.xmlbeans.impl.common.*;
...
import poi.org.apache.xmlbeans.impl.common.GlobalLock;
...
import poi.org.apache.xmlbeans.DelegateXmlObject;
    ...
    */
    ...
    protected double[] getDoubleArray(QName elementName) {
        synchronized (monitor()) {
            ...
            return targetList.stream()
                ...
                .mapToDouble(SimpleValue::getDoubleValue)
                .toArray();
        }
    }
    ...
    protected int[] getIntArray(QName elementName) {
        synchronized (monitor()) {
            ...
            return targetList.stream()
                .map(SimpleValue.class::cast)
                .mapToInt(SimpleValue::getIntValue)
                .toArray();
        }
    }
    ...
    protected long[] getLongArray(QName elementName) {
        synchronized (monitor()) {
            ...
            return targetList.stream()
                .map(SimpleValue.class::cast)
                .mapToLong(SimpleValue::getLongValue)
                .toArray();
        }
    }
