...
public class XmlObjectFactory<T> extends DocumentFactory<T> {
     ...
     */
    @Override
    public T parse(java.net.URL u) throws XmlException, java.io.IOException {
     ...
     */
    @Override
    public T parse(java.net.URL u, XmlOptions options) throws XmlException, java.io.IOException {
