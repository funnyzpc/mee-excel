 ...
 * category of token is represented by a {@link TokenType TokenType}.
 * <p>
 ...
 * by one of the nine types defined by the {@link TokenType TokenType} class.
 * <p>
...
//    void setTextValue(String text);
     ...
     *                    value.
     * @throws IllegalArgumentException If the token type at this
     *                                            cursor's location is not START, STARTDOC, ATTR, COMMENT or
     *                                            PROCINST.
     */
...
//    XmlCursor execQuery(String query, XmlOptions options);
     ...
     * If the {@link XmlBookmark#getKey() getKey} method is not overridden on
     ...
     * @throws IllegalArgumentException If the insertion is not allowed
     *                                            at the cursor's location.
     */
     ...
     * @throws IllegalStateException If the insertion is not allowed
     *                                         at the cursor's location.
     */
