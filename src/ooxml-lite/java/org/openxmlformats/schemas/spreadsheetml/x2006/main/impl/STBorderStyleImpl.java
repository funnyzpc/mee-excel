 ...
 */
public class STBorderStyleImpl extends JavaStringEnumerationHolderEx implements org.openxmlformats.schemas.spreadsheetml.x2006.main.STBorderStyle {
    private static final long serialVersionUID = 1L;

    public STBorderStyleImpl(SchemaType sType) {
        super(sType, false);
    }

    protected STBorderStyleImpl(SchemaType sType, boolean b) {
        super(sType, b);
    }
}
