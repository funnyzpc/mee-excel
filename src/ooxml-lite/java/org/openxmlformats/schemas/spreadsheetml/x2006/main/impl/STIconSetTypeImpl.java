 ...
 */
public class STIconSetTypeImpl extends JavaStringEnumerationHolderEx implements org.openxmlformats.schemas.spreadsheetml.x2006.main.STIconSetType {
    private static final long serialVersionUID = 1L;

    public STIconSetTypeImpl(SchemaType sType) {
        super(sType, false);
    }

    protected STIconSetTypeImpl(SchemaType sType, boolean b) {
        super(sType, b);
    }
}
