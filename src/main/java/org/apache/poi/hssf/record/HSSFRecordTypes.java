...
//    ESCHER_AGGREGATE(9876, EscherAggregate.class, (in) -> new EscherAggregate(true))
    ...
    HSSFRecordTypes(int sid, Class<? extends Record> clazz, RecordConstructor<? extends Record> recordConstructor) {
        this(sid, clazz, recordConstructor,true);
    }

    HSSFRecordTypes(int sid, Class<? extends Record> clazz, RecordConstructor<? extends Record> recordConstructor, boolean parse) {
        this.sid = (short)sid;
        this.clazz = clazz;
